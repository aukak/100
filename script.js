  ...
  return /*#__PURE__*/(
    React.createElement("div", {
      ...
      style: {
        ...
        '--lightness': lightness,
        '--saturation': saturation } }, /*#__PURE__*/

    React.createElement("div", {
      className: "hsl-slider__arc",
      style: {
        '--value': Math.max(0, Math.min(100, hue / 360 * 100)) } }), /*#__PURE__*/
...
const App = () => {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: "container", style: { '--color': color.toHslString() } }, /*#__PURE__*/
    React.createElement(HslSlider, {
      hue: color.hue,
      saturation: color.sat * 100,
      lightness: color.lightness * 100,
      onChange: onChange }), /*#__PURE__*/

    React.createElement("div", { className: "values" }, /*#__PURE__*/
    React.createElement("h1", null, color.toHslString()), /*#__PURE__*/
    React.createElement("h1", null, color.toHexString()), /*#__PURE__*/
    React.createElement("h1", null, color.toRgbString()))));
